...
that runs on behalf of simulated users to create a data set of random CHIP 
trades.
...
Windows has a similar system for importing certificate authorities.  For Linux,
you may have to import it directly into the browser you are using.  You may 
also have to restart Firefox if that is the browser you are using.
