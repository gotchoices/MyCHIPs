...
const ReceiveShareTally = (props) => {
  ...
  useEffect(() => {
    ...
    request(wm, `_invite_ref_json_${random(1000)}`, "action", spec)
      .then((data) => {
        const json = data?.[0];
        const link = data?.[1];
  ...
  return (
    <View style={styles.container}>
      <View style={styles.tab}>
        <TouchableWithoutFeedback onPress={changeTab("qr")}>
          <View
            style={[styles.tabItem, activeTab === "qr" ? styles.activeTab : {}]}
          >
            <Text
              style={[
                styles.tabText,
                activeTab === "qr" ? styles.activeText : {},
              ]}
            >
              QR Code
            </Text>
        ...
        <TouchableWithoutFeedback onPress={changeTab("link")}>
          <View
            style={[
              styles.tabItem,
          ...
          >
            <Text
              style={[
                styles.tabText,
                activeTab === "link" ? styles.activeText : {},
              ]}
            >
              Link
            </Text>
...
export default ReceiveShareTally;
