...
const GeneratePassphraseModal = (props) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Generate Key</Text>

      <Text style={styles.text}>
      It’s recommended to export your current key before generating a new one.
      </Text>

      <Text style={styles.text}>
      Your key will be encrypted with a passphrase. Store your passphrase in a safe place. You will need it in order to use the exported key.
      </Text>
...
export default GeneratePassphraseModal;
