...
class TransactionPageState extends State<TransactionPage>
  ...
  void initState() {
    ...
    _animation = Tween<double>(begin: 0, end: 1.5).animate(CurvedAnimation(
  ...
  Widget buildAccountTitle() {
    return Container(
        ...
        child: Row(children: [
          CircleAvatar(
              child: Text(widget.transactionPartner.displayName.substring(0, 1),
                  style: TextStyle(
                      fontSize: 16,
                  ...
                  if (checkParameterFormat(t)) {
                    showDialog(
                        ...
                        builder: (BuildContext context) =>
                            confirmPayRequestDialog(false, t.amount, t));
                  }
                },
                child: Text('REQUEST',
                    style:
                ...
                onPressed: () {
                  ...
                  if (checkParameterFormat(t)) {
                    showDialog(
                        ...
                        barrierDismissible: false,
                        builder: (BuildContext context) =>
                            confirmPayRequestDialog(true, t.amount, t));
                  }
                },
                child: Text('PAY',
  ...
  bool checkParameterFormat(Transaction t) {
    if (t.receiver == null || t.receiver == "") {
      ...
      return false;
    } else if ((t.amount = t.amount) == null) {
