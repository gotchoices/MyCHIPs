...
// -----------------------------------------------------------------------------
// TODO:
//X- Read initial parameters from base.parm_v
//X- Establish interrupt schedule
//X- On each cycle, call an actor function on behalf of each entity
...
#Fixme: use try-catch block here
      var msg = JSON.parse(payload)
      if (channel == 'parm_agent') {
#Fixme: can just grab individual parameter from payload value now
