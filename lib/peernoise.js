...
//- Are encrypt and siteKey switches redundant?		Yes, get rid of encrypt switch
//- Need to delete manager peer key cache entry if the keyy ever fails
//- Implement (or remove) queue functionality
//- When do messages need to be queued?
//- 
