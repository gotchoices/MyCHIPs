...
class SQLManager {
    ...
    addConnectionRequest(requestingAccountID, requestingAccountCertificate, targetAccountCertificate) {
        ...
        this.query('insert into mychips.tallies_v (tally_ent, tally_uuid, request, hold_cert, part_cert, hold_sig, tally_type) values ($1, $2, $3, $4, $5, $6, $7);', [
            requestingAccountID,
            uuid,
            'offer',
    ...
    requestLift(start_peer_cuid, end_peer_cuid) {
        this.dbConnection.query('select mychips.lift_circuit($1, $2)', [start_peer_cuid, end_peer_cuid], (err, result) => {
            if (err) {
