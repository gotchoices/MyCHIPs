...
class FindEmployer {
    ...
    run() {
        this.worldDBManager.findPeerAndUpdate(this.account.peer_cuid, this.account.incomeSources, (newPeer) => {
            this.logger.debug('employee: ', this.account.peer_cuid, ' attempting new employer with ', newPeer.peer_cuid);
