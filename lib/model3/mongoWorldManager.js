...
class MongoManager {
    ...
    updateOneAccount(account) {
        this.accountsCollection.updateOne({ peer_cuid: account.peer_cuid, host: account.peer_host }, { $set: account }, { upsert: true }, (e, r) => {
            if (e) {
    ...
    findPeerAndUpdate(hostedAccountPeerCid, alreadyConnectedAccounts, callback) {
        ...
        this.accountsCollection
            ...
            if (res.ok && res && res.value) {
                this.logger.debug('  Best peer:', (_a = res === null || res === void 0 ? void 0 : res.value) === null || _a === void 0 ? void 0 : _a.peer_cuid, (_b = res === null || res === void 0 ? void 0 : res.value) === null || _b === void 0 ? void 0 : _b.agent);
                callback(res.value);
            }
            else {
