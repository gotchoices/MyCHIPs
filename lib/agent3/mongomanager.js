        ...
        if (doc.action == 'createUser') {
          ...
          checkPeer(doc.data, (agentData) => {
            ...
            this.logger.debug(
              ...
              agentData.peer_cid,
              'notifying:',
              (_a = doc.data) === null || _a === void 0 ? void 0 : _a.host
            )
            this.actionsCollection.insertOne(
              {
                ...
                tag: doc.tag,
                host:
                  (_b = doc.data) === null || _b === void 0 ? void 0 : _b.host,
                from: this.host,
              },
              () => {}
            )
    ...
    this.agentsCollection.findOneAndUpdate(
      ...
      (e, res) => {
        ...
        if (e) {
          ...
          this.logger.verbose(
            '  Best client:',
            (_a = res === null || res === void 0 ? void 0 : res.value) ===
              null || _a === void 0
              ? void 0
              : _a.std_name,
            (_b = res === null || res === void 0 ? void 0 : res.value) ===
              null || _b === void 0
              ? void 0
              : _b.host
          )
