...
class BaseAgent {
    constructor(agentData, agentParams) {
        ...
        this.actions.push(actionFactory_1.default.createAction('PayVendor', this));
        this.actions.push(actionFactory_1.default.createAction('TallyState', this));
