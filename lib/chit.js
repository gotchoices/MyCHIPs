...
//log.debug("chit local pend:", JSON.stringify(msg))
...
//log.debug("chit local void:", JSON.stringify(msg))
      let pmsg = Object.assign({}, msg)
        , dmsg = {target:msg.target, to: msg.from, object: {tally:msg.object.tally, uuid:msg.object.uuid}}
...
//log.debug("chit local good:", JSON.stringify(msg))
      let pmsg = Object.assign({}, msg)
        , dmsg = {target:msg.target, to: msg.from, object: {tally:msg.object.tally, uuid:msg.object.uuid}}
      this.peerTransmit(pmsg, ()=>{		//If I can notify the peer
...
//log.debug("chit remote pend:", JSON.stringify(msg))
      this.dbProcess(msg, {
        context: ['null', 'L.void'], 
        upsert: {status: 'pend'}
...
//log.debug("chit remote void:", JSON.stringify(msg))
      this.dbProcess(msg, {
        context: ['A.pend'],
