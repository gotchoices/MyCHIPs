...
//log.debug("chit local pend:", msg, msg.to.cid, msg.object.uuid)
      let pmsg = Object.assign({}, msg)
        , object = {tally:msg.object.tally, uuid:msg.object.uuid}
        , dmsg = {target:msg.target, to: msg.from, object}
...
//log.debug("chit local void:", msg, msg.to)
      let pmsg = Object.assign({}, msg)
        , object = {tally:msg.object.tally, uuid:msg.object.uuid}
        , dmsg = {target:msg.target, to: msg.from, object}
...
//log.debug("chit local good:", msg, msg.to)
      let pmsg = Object.assign({}, msg)
        , object = {tally:msg.object.tally, uuid:msg.object.uuid}
        , dmsg = {target:msg.target, to: msg.from, object}
      this.peerTransmit(pmsg, ()=>{		//If I can notify the peer
...
//log.debug("chit remote pend:", msg, 'T:', msg.to.cid, msg.object.uuid)
      this.dbProcess(msg, {
        context: ['null', 'L.void'], 
        upsert: {status: 'pend'}
...
//log.debug("chit remote void:", msg, msg.to)
      this.dbProcess(msg, {
        context: ['A.pend'],
