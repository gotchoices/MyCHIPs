...
log.debug("userRequest:", msg.object.guid, msg.object.units)
    ...
    userDraft: function(msg) {		//The user is sending money voluntarily
      var pmsg = Object.assign({}, msg, {action: 'peerValid', user: msg.peer})
      delete pmsg['entity']; delete pmsg['peer']
log.debug("userDraft:", msg.object.guid, msg.object.units)
      this.peerTransmit(pmsg, ()=>{
        this.dbProcess(msg, {
...
log.debug("peerValid:", msg.object.guid, msg.object.units)
      this.dbProcess(msg, {
