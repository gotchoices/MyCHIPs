...
module.exports = class AgentCluster {
  ...
  run() {
    ...
    this.#worldDBManager.createConnection(WorldDBOpts, this.loadInitialUsers)
  ...
  loadParamsConfig() {
    ...
    try {
      let fileContents = fs.readFileSync('./agent3/paramConfig.yaml', 'utf8') //FIXME
