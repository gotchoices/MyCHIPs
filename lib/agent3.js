...
class AgentCluster {
    constructor(myChipsDBConfig, worldDBConfig, networkConfig) {
        ...
        this.logger = (0, wyclif_1.Log)('agent');
    ...
    configureDatabases(myChipsDBConfig, worldDBConfig) {
        ...
        this.myChipsDBManager = new sqlmanager_1.default(myChipsDBConfig, this.logger, this.params);
        // Configure MongoManager
        this.worldDBManager = new mongomanager_1.default(worldDBConfig, this.logger, this.networkConfig);
    }
