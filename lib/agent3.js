...
class AgentCluster {
    ...
    run() {
        ...
        this.worldDBManager.createConnection(this.checkPeer, this.notifyOfActionDone, this.loadInitialUsers);
    ...
    notifyTryTally(agentData, queryResponseVal) {
    ...
    remoteCall(host, command, data, cb) {
