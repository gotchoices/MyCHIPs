...
insert into wm.message_text (mt_sch,mt_tab,code,language,title,help) values
  ...
  ('mychips','tallies_v_me','GTT','eng','Generating Tally','An error occurred while generating a tally invitation ticket'),
  ...
  ('mychips','users_v','GUT','eng','Generating Ticket','An error occurred while generating a user connection ticket'),
  ...
  ('mychips','users_v','URF','eng','Unknown Format','The requested report format is unsupported'),
...
insert into wm.table_style (ts_sch,ts_tab,sw_name,sw_value,inherit) values
  ...
  ('mychips','users_v','actions','[{"name": "ticket", "render": "html", "single": "1", "options": [{"tag": "format", "input": "pdm", "values": ["qr", "link"]}]}, {"ask": "1", "name": "lock"}, {"ask": "1", "name": "unlock"}, {"name": "summary", "render": "html"}, {"name": "trade", "render": "html", "options": [{"tag": "start", "hint": "date", "size": "11", "type": "date", "input": "ent", "special": "cal", "subframe": "1 1", "template": "date"}, {"tag": "end", "hint": "date", "size": "11", "type": "date", "input": "ent", "special": "cal", "subframe": "1 2", "template": "date"}]}]','f'),
