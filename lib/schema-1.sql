...
create view mychips.tallies_v as select 
    te.tally_ent, te.request, te.comment, te.cr_limit, te.dr_limit, te.tally_guid, te.tally_type, te.version, te.partner, te.contract, te.crt_by, te.mod_by, te.crt_date, te.mod_date, te.tally_date, te.status
...
$$;
create function mychips.tally_state(cdi text, obj jsonb, recipe jsonb) returns text language plpgsql as $$
    declare
        curState	text;
        lrec		record;
        entity		int;
