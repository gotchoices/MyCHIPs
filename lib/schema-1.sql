...
insert into wm.column_style (cs_sch,cs_tab,cs_col,sw_name,sw_value) values
  ...
  ('mychips','agents','agent_port','max','10'),
  ('mychips','agents','agent_port','min','0'),
  ...
  ('mychips','contracts','domain','subframe','{"x": 1, "y": 1}'),
  ...
  ('mychips','tallies_v','part_cid','subframe','{"x": 3, "y": 16}'),
  ...
  ('mychips','tallies_v','part_name','subframe','{"x": 3, "y": 16}'),
  ...
  ('mychips','tallies_v','part_sock','subframe','{"x": 3, "y": 16}'),
  ...
  ('mychips','tallies_v','user_cid','subframe','{"x": 3, "y": 14}'),
  ...
  ('mychips','tallies_v','user_name','subframe','{"x": 3, "y": 14}'),
  ...
  ('mychips','tallies_v','user_sock','subframe','{"x": 3, "y": 14}'),
  ...
  ('mychips','users','peer_named','subframe','{"x": 1, "y": 3, "xspan": 2}'),
  ...
  ('tabdef mychips','tallies','tally_type','input','"ent"'),
