...
insert into wm.column_text (ct_sch,ct_tab,ct_col,language,title,help) values
  ...
  ('mychips','chits','chain_send','eng','Chain Send','Holds missing chain information to be communicated to the partner about chit consensus'),
  ...
  ('mychips','tallies_v_net','canlift','eng','Can Lift','True if there is lift capacity on this tally'),
...
insert into wm.table_style (ts_sch,ts_tab,sw_name,sw_value,inherit) values
  ...
  ('mychips','tallies_v_liftss','0','"d"','t'),
  ('mychips','tallies_v_liftss','1','"i"','t'),
  ('mychips','tallies_v_liftss','10','"a"','t'),
  ('mychips','tallies_v_liftss','11','"n"','t'),
  ('mychips','tallies_v_liftss','12','"g"','t'),
  ('mychips','tallies_v_liftss','13','" "','t'),
  ('mychips','tallies_v_liftss','14','"l"','t'),
  ('mychips','tallies_v_liftss','15','"e"','t'),
  ('mychips','tallies_v_liftss','16','"n"','t'),
  ('mychips','tallies_v_liftss','17','"g"','t'),
  ('mychips','tallies_v_liftss','18','"t"','t'),
  ('mychips','tallies_v_liftss','19','"h"','t'),
  ('mychips','tallies_v_liftss','2','"s"','t'),
  ('mychips','tallies_v_liftss','20','" "','t'),
  ('mychips','tallies_v_liftss','21','"m"','t'),
  ('mychips','tallies_v_liftss','22','"i"','t'),
  ('mychips','tallies_v_liftss','23','"n"','t'),
  ('mychips','tallies_v_liftss','24','" "','t'),
  ('mychips','tallies_v_liftss','25','"m"','t'),
  ('mychips','tallies_v_liftss','26','"a"','t'),
  ('mychips','tallies_v_liftss','27','"x"','t'),
  ('mychips','tallies_v_liftss','28','" "','t'),
  ('mychips','tallies_v_liftss','29','"f"','t'),
  ('mychips','tallies_v_liftss','3','"p"','t'),
  ('mychips','tallies_v_liftss','30','"o"','t'),
  ('mychips','tallies_v_liftss','31','"r"','t'),
  ('mychips','tallies_v_liftss','32','"a"','t'),
  ('mychips','tallies_v_liftss','33','" "','t'),
  ('mychips','tallies_v_liftss','34','"f"','t'),
  ('mychips','tallies_v_liftss','35','"o"','t'),
  ('mychips','tallies_v_liftss','36','"r"','t'),
  ('mychips','tallies_v_liftss','37','"z"','t'),
  ('mychips','tallies_v_liftss','38','" "','t'),
  ('mychips','tallies_v_liftss','39','"p"','t'),
  ('mychips','tallies_v_liftss','4','"l"','t'),
  ('mychips','tallies_v_liftss','40','"a"','t'),
  ('mychips','tallies_v_liftss','41','"t"','t'),
  ('mychips','tallies_v_liftss','42','"h"','t'),
  ('mychips','tallies_v_liftss','43','"}"','t'),
  ('mychips','tallies_v_liftss','5','"a"','t'),
  ('mychips','tallies_v_liftss','6','"y"','t'),
...
(
      ...
      NULL,
      '2020-04-01',
      E'\\xe3d0e5aa6189d8396437fbb30797273de3fcb8917cceebc6e1a11951e3480408',
      'Defining a CHIP',
...
,(
      ...
      NULL,
      '2020-04-01',
      E'\\xcc423f140a4835ea096370fd6d10e1b4bcc27d783e0db2ce58a915f112998eab',
...
,(
      ...
      NULL,
      '2020-04-01',
      E'\\xc704c0846d1bbbf10e38ae635467249cfcdf612fb627ecf0d60779361b764110',
...
,(
      ...
      NULL,
      '2020-04-01',
      E'\\xa156dc100b1b74997853835f776c7721858ed5bfe3c40a5a39b9ecd83ac1c8b0',
...
,(
      ...
      NULL,
      '2020-04-01',
      E'\\x2c5c1f732a572821ebccde4e75c9354bee2b7d251a128f447cc8942264a597a5',
      'Ethical Conduct',
...
,(
      ...
      NULL,
      '2020-04-01',
      E'\\xfa4bd06347ca6164c1635b9fd85ec25f45c574adcadbfe5135735b5abf0f3039',
...
,(
      ...
      NULL,
      '2020-04-01',
      E'\\x9233d65f8a19ddbbcc4e620114cf194cab9ebd94635577fd39d1f98ade5a6830',
...
,(
      ...
      't',
      '2020-04-01',
      E'\\xa0fb64fcec78ef93eb974385c8b99399d898cb3589ae10d29cd0b02d52c90187',
      'Tally Contract',
...
,(
      ...
      NULL,
      '2020-04-01',
      E'\\x9cff2fd7edf0471eb58bfad05f8986aee2c7fa5226602b1c9eea31af35398a56',
