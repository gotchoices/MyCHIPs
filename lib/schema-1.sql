...
create view mychips.users_v as select 
  ...
  , host(peer_inet) || ':' || peer_port	as peer_sock
  , extract(year from age(ee.born_date))		as age
...
insert into wm.table_style (ts_sch,ts_tab,sw_name,sw_value) values
  ...
  ('mychips','peers_v','display','id std_name peer_cdi peer_sock ent_type born_date !fir_name !ent_name'),
  ...
  ('mychips','users_v','display','id std_name user_sock ent_type born_date !fir_name !ent_name'),
...
insert into wm.column_native (cnt_sch,cnt_tab,cnt_col,nat_sch,nat_tab,nat_col,nat_exp,pkey) values
  ...
  ('mychips','users_v_flat','age','mychips','users_v','age','f','f'),
  ...
  ('mychips','users_v','age','mychips','users_v','age','f','f'),
