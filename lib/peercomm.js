...
// open channel will serve the same purpose as a channel initiatef from this end.
// -----------------------------------------------------------------------------
// TODO:
...
log.debug('Initializing peer pool:', port)
    ...
    this.server = Net.createServer(sock => {		//Initialize server to receive peer connections
      log.trace('Peer initiated connection:', port)
      log.trace('  remote address:', sock.remoteAddress)
...
log.trace("First line:", msg)
          ...
          log.debug(' Remote data:', remoteServer, msg)
