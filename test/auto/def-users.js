...
var aCon0 = {host, port: port0, keys:{publicKey:aKey0}, test: false}
var aCon1 = {host, port: port1, keys:{publicKey:aKey1}, test: false}
var aCon2 = {host, port: port2, keys:{publicKey:aKey2}, test: false}
