...
#define NUM_PAYMENTS 1 //number of payments allowed per node
#define NUM_LIFTS 2 //number of lifts the leader can call for
...
proctype leader(byte id) {
    ...
    :: lifts_remaining > 0 && !lift_in_progress ->
        atomic{
            down_send!proposed_lift(foils[id])
